...
public class InputActions : IInputActionCollection
{
    ...
    ""controlSchemes"": [
        ...
        // CharacterController
        m_CharacterController = asset.FindActionMap("CharacterController");
        m_CharacterController_Move = m_CharacterController.FindAction("Move");
        m_CharacterController_Look = m_CharacterController.FindAction("Look");
        m_CharacterController_Fire = m_CharacterController.FindAction("Fire");
        m_CharacterController_Jump = m_CharacterController.FindAction("Jump");
        // UI
        m_UI = asset.FindActionMap("UI");
        m_UI_Navigate = m_UI.FindAction("Navigate");
        m_UI_Submit = m_UI.FindAction("Submit");
        m_UI_Cancel = m_UI.FindAction("Cancel");
        m_UI_Point = m_UI.FindAction("Point");
        m_UI_Click = m_UI.FindAction("Click");
        m_UI_ScrollWheel = m_UI.FindAction("ScrollWheel");
        m_UI_MiddleClick = m_UI.FindAction("MiddleClick");
        m_UI_RightClick = m_UI.FindAction("RightClick");
        // Vehicle
        m_Vehicle = asset.FindActionMap("Vehicle");
        m_Vehicle_Steering = m_Vehicle.FindAction("Steering");
        m_Vehicle_Throttle = m_Vehicle.FindAction("Throttle");
        m_Vehicle_Previous = m_Vehicle.FindAction("Previous");
        m_Vehicle_Next = m_Vehicle.FindAction("Next");
        m_Vehicle_Look = m_Vehicle.FindAction("Look");
    }
